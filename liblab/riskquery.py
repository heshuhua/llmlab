...
# --- 配置 ---
faiss_index_path = "risk_support_faiss_index"
...
while True:
    ...
    filter_category = input("你想指定项目经理吗？(例如: 张宇, 乔洪垒, 马贺, 或留空): ").strip()
    filter_date_str = input("你想只看计划上线时间？(例如: 2025-05-01, 或留空): ").strip()
